...
export function ErrorBanner({ error, onDismiss, onRetry }) {
  ...
  return (
    <div className="bg-rose-50/70 border border-slate-200/70 rounded-xl p-3.5 my-2.5 text-rose-900 shadow-xs animate-in fade-in duration-150">
        ...
        <div className="flex items-start gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              {error.code && (
                <span className="font-mono text-[10px] px-1.5 py-0.2 rounded bg-rose-100 text-rose-800 border border-slate-200/60">
                  {error.code}
                </span>
              )}
            </div>
            ...
            {isGasError && (
              <div className="mt-2.5">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 bg-white border border-slate-200 px-2.5 py-1 rounded-lg hover:bg-slate-50 transition-colors shadow-xs"
                >
